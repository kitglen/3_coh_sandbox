class Api::V3::DoctorsController < ApplicationController
  resource_description do
    ...
    version '3'
    formats ['json']
    param :id, Integer, :desc => "V3::Doctor ID", :required => false
    param :doctor, Hash, :desc => "V3::Doctor's parameters for all methods" do
  ...
  # GET /doctors.json
  api :GET, "/v3/doctors.json", "Show all doctors based on a query scope"
  def index
  ...
  # GET /doctors/1.json
  api :GET, "/v3/doctors/:id.json", "Show doctor"
  def show
  ...
  api :GET, "/v3/doctors/new.json", "Instantiate a new doctor"
  def new
  ...
  # POST /doctors.json
  api :POST, "/v3/doctors.json", "Create a new doctor"
  def create
  ...
  # PUT /doctors/1.json
  api :PUT, "/v3/doctors/:id.json", "Update an existing doctor"
  def update
  ...
  api :DELETE, "/v3/doctors/:id.json", "Delete an existing doctor"
  def destroy
...
protected
  def scope_named(name)
    scope = 'all' unless ::V3::Doctor.respond_to?(name)
    if name == 'all'
      ...
      scope = ::V3::Doctor.count
    else
      scope = ::V3::Doctor.send(name, (params[:query] || {}), {}, params[:offset], params[:limit])
    end
    scope
  end
  ...
  include Api::V3::Custom::DoctorsController
end
