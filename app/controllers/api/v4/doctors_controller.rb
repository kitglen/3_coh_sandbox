class Api::V4::DoctorsController < ApplicationController
  resource_description do
    ...
    version '4'
    formats ['json']
    param :id, Integer, :desc => "V4::Doctor ID", :required => false
    param :doctor, Hash, :desc => "V4::Doctor's parameters for all methods" do
  ...
  # GET /doctors.json
  api :GET, "/v4/doctors.json", "Show all doctors based on a query scope"
  def index
  ...
  # GET /doctors/1.json
  api :GET, "/v4/doctors/:id.json", "Show doctor"
  def show
  ...
  api :GET, "/v4/doctors/new.json", "Instantiate a new doctor"
  def new
  ...
  # POST /doctors.json
  api :POST, "/v4/doctors.json", "Create a new doctor"
  def create
  ...
  # PUT /doctors/1.json
  api :PUT, "/v4/doctors/:id.json", "Update an existing doctor"
  def update
  ...
  api :DELETE, "/v4/doctors/:id.json", "Delete an existing doctor"
  def destroy
...
protected
  def scope_named(name)
    scope = 'all' unless ::V4::Doctor.respond_to?(name)
    if name == 'all'
      ...
      scope = ::V4::Doctor.count
    else
      scope = ::V4::Doctor.send(name, (params[:query] || {}), {}, params[:offset], params[:limit])
    end
    scope
  end
  ...
  include Api::V4::Custom::DoctorsController
end
